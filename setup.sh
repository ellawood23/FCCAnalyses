if [ "${0}" != "${BASH_SOURCE}" ]; then
  ...
  ## Local delphes version (again)
  export LD_LIBRARY_PATH=/r02/lhcb/ejnw2/FCC_FT/delphes351pre05/delphes/delphes/install/lib:${LD_LIBRARY_PATH}
  export CMAKE_PREFIX_PATH=/r02/lhcb/ejnw2/FCC_FT/delphes351pre05/delphes/delphes/install:$CMAKE_PREFIX_PATH
  export DELPHES_DIR=/r02/lhcb/ejnw2/FCC_FT/delphes351pre05/delphes/delphes/install
